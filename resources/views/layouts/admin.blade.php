...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        para que pueda ver la lista para ver y editar usuario --}}
                        @if( Auth::user()->id==1 )
                            <li>
    ...
    {{-- Para evitar cargar el script en toda la vista admin, sino
    específicamente en Género, ya que es donde se utiliza el script --}}
    @section("script")
    @show
